...
Caso não funcione, executar os seguintes comandos manualmente para compilar todos os arquivos do projeto:
  gcc main.c -o main.o -c
  gcc funcs.c -o funcs.o -c
  gcc -o trab2.exe main.o funcs.o