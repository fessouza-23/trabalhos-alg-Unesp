...
int* get_type_of_array(int *array_to_be_sorted) {
    ...
    do {
        ...
        switch (menu_option) {
            case '1':
                write_file_in_array("unsorted_values.txt", array_to_be_sorted);
                break;
            case '2':
                write_file_in_array("partially_sorted_values.txt", array_to_be_sorted);
                break;
            case '3':
                write_file_in_array("ascending_sorted_values.txt", array_to_be_sorted);
                break;
            case '4':
                write_file_in_array("descending_sorted_values.txt", array_to_be_sorted);
                break;
            default:
